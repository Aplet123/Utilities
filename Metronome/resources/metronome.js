...
beat.addEventListener("change",function(){if(start===true){window.clearInterval(window.interval);display.innerHTML=1;}});
back.addEventListener("click",function(){if(start===true){window.clearInterval(window.interval);display.innerHTML=1;}});
next.addEventListener("click",function(){if(start===true){window.clearInterval(window.interval);display.innerHTML=1;}});
